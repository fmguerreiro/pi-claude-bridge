...
- **Performance: load the extension from a prebuilt bundle** — package entrypoints now use one generated ESM file instead of making the host transform the full source dependency graph at startup.
